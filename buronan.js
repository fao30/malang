...
function render() {
  ...
  for (let i = 0; i < dataBuronan.length; i++) {
    ...
    let bunga = dataBuronan[i].nominal + (dataBuronan[i].nominal * 100) / 100;
    newTodo.innerText = `${dataBuronan[i].nama} -- ${dataBuronan[i].alamat} -- ${dataBuronan[i].telp} -- ${dataBuronan[i].dueDate} -- ${dataBuronan[i].nominal}-- ${bunga}`;
